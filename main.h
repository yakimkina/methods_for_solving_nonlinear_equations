...
#define	TEST2	true	// true если во 2 тесте берем нач. приближение x0 = 8
...
#define	DIAGRAM	true // построить диаграмму сходимости, все точки сохраняются в файл в папку DIR
